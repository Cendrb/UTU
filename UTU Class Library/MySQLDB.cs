...
namespace UTU_Class_Library
{
    public class MySQLDB
    {
        ...
        //Constructor
        public MySQLDB(string password)
        {
            Initialize(password);
        }
        ...
        public void Insert(string table, List<string> keys, List<string> values)
        {
            ...
            string query = String.Format("INSERT INTO {0} ({1}) VALUES({2})", table, keysString.ToString(), valuesString.ToString());
        ...
        public void Insert(Events item)
        {
            List<string> values = new List<string>();
            values.Add(item.Id.ToString());
            values.Add(item.Name);
            values.Add(item.Description);
            values.Add(item.From.ToShortDateString());
            values.Add(item.Place);
            values.Add(item.To.ToShortDateString());
